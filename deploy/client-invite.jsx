          ...
          {msg.creds && (
            <div style={{
             ...
             <div style={{ marginTop: 8, paddingTop: 8, borderTop: '1px solid rgba(255,255,255,0.08)', display: 'flex', gap: 8 }}>
               <a
                  href={`https://mail.google.com/mail/u/bryan@peakformbio.com/?view=cm&fs=1&to=${encodeURIComponent(msg.creds.email)}&su=${encodeURIComponent('Welcome to PeakForm Bio — your portal access')}&body=${encodeURIComponent(`Welcome to PeakForm Bio. Sign in here:\n${msg.creds.portalUrl}\n\nEmail: ${msg.creds.email}\nPassword: ${msg.creds.password}\n\nUse the "Use email & password" option on the sign-in screen.`)}`}
