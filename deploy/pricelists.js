...
window.PRICELISTS = {
  standard: {
    ...
    products: [
      ...
      { name: 'CJC-1295 + Ipamorelin — 5+5mg', price: 175, category: 'Peptides' },
      { name: 'Ipamorelin — 10mg',     price: 125, category: 'Peptides' },
      ...
      { name: 'HGH — 10IU',            price:  45, category: 'Peptides' },
      { name: 'HGH — 36IU',            price:  85, category: 'Peptides' },
      ...
      { name: 'L-Carnitine',           price: 100, category: 'Wellness' },
      // GLP-1 / Weight Loss
  ...
  wholesale: {
    ...
    products: [
      ...
      { name: 'CJC-1295 + Ipamorelin — 5+5mg', price:  65, category: 'Peptides' },
      { name: 'Ipamorelin — 10mg',     price:  50, category: 'Peptides' },
      ...
      { name: 'L-Carnitine',           price:  55, category: 'Wellness' },
      // GLP-1 / Weight Loss
