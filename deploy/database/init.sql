...
-- ─── Workout Sessions ────────────────────────────────────────────────────────
-- Logged workouts from the athlete tracker. The full component-shaped session
-- (camelCase: durationSec, totalVolumeLb, prs[], exercises[]) is kept in `data`;
-- the flat columns are for indexing / coach-dashboard queries.
